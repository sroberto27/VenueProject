	...
	<div class="sidebar" id="sidebar">
		...
		<div id="sidemenu">
			...
			<ul>
				...
				<li><a href="/project/venueproject/search.php"class="active">Search</a></li>
...
$sql = "SELECT * FROM booking";// embed a select statement in php
...
if ($row3['statusID']==$row['statusID']) {
$tempd=$row3['description'];
}
}
$sql5= "SELECT * FROM rooms";
$result5 = $conn->query($sql5);
while($row4 = $result5->fetch_assoc()) {
if ($row4['roomID']==$row['roomID']) {
$tempr=$row4['roonName'];
}
}
		...
		echo "Room : ". $tempr."<br>";
		echo "description : ". $tempd."<br>";
	echo '<a href="modify.php?PerID='.$row['bookingID'].'">Modify </a></';
	echo "</div>";
	echo "</li>";
